                ...
                <section class="col-lg-7 connectedSortable">
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body chat" id="chat-box">
                            <div class="item">
                                <img src={{--"{{asset('dist/img/user1-128x128.jpg')}}--}}" alt="user image" class="online">
                        ...
                        <div class="box-body">
                            <form action="#" method="post">
                                <div class="form-group">
                                    <input type="email" class="form-control" name="emailto" placeholder="A:">
                                </div>
                                <div class="form-group">
                ...
                <section class="col-lg-5 connectedSortable">
                        ...
                        <div class="box-footer no-border">
                            <div class="row">
                                ...
                                <div class="col-xs-4 text-center">
                                    ...
                                    <div class="knob-label">Existants</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="box box-solid bg-teal-gradient">
                        <div class="box-header">
                            ...
                            <h3 class="box-title">Graphes des ventes</h3>
                        ...
                        <div class="box-footer no-border">
                            <div class="row">
                                <div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
                                    ...
                                    <div class="knob-label">Demandes</div>
                                </div>
                                <div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
                            ...
                            <div class="pull-right box-tools">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-right" role="menu">
                                        ...
                                        <li><a href="#">Effacer des évenements</a></li>
                                        <li class="divider"></li>
        ...
        <section class="content">
            ...
            <div class="row">
                                    ...
                                    <div class="direct-chat-messages">
                                        ...
                                        <div class="direct-chat-msg">
                                            <div class="direct-chat-info clearfix">
                                                <span class="direct-chat-name pull-left">Mike Tsebo</span>
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Derniers ajouts de Produits</h3>
                            ...
                            <ul class="products-list product-list-in-box">
                                ...
                                <li class="item">
                                    <div class="product-img">
                                        @if(\Illuminate\Support\Facades\Storage::disk('public')->exists($produit->image))
                                        <img src="{{asset('/storage/'.$produit->image)}}" alt="produit image">
                                        @endif
                                    </div>
                                    <div class="product-info">
                                        <a href="{{route('produit.show',['id'=>$produit->id])}}" class="product-title">{{$produit->nom}}
                                            <span class="label label-warning pull-right">{{$produit->prix_unit}} FCFA</span></a>
                        ...
                        <!-- /.box-body -->
                        <div class="box-footer text-center">
                            <a href="javascript:void(0)" class="uppercase">Voir tous les produits</a>
                        </div>
                        <!-- /.box-footer -->
                    </div>
                    <!-- /.box -->
