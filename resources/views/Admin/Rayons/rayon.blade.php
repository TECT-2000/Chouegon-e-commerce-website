        ...
        <section class="content">
            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
                            {{Form::open(['method'=>'post','route'=>['rayon.store']])}}
                            <div class="form-group">
                                {!! Form::label('nom','Nom du rayon') !!}
                                {!! Form::text('nom','',['class'=>'form-control','placeholder'=>'nom du rayon']) !!}
                            </div>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Liste des rayons</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
        ...
        <div class="modal-dialog text-center">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title text-red"><i class="fa fa-times-circle"></i> Suppresion de rayon</h4>
                </div>
                <div class="modal-body">
                    <h1 class="">Voulez-vous vraiment supprimer {{$rayon->nom}} ?</h1>
                </div>
